...
class ViajeBusBootstrap extends CollectionBasedBootstrap{
	...
	override run() {
		...
		val viaje1 = repoViajes.create(partidaMicro1, llegadaMicro1, micro1)
		val viaje2 = repoViajes.create(partidaMicro2, llegadaMicro2, micro2)
		val viaje3 = repoViajes.create(partidaMicro3, llegadaMicro3, micro3)
